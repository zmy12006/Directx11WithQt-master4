...
public:
    ...
    void retranslateUi(QMainWindow *MainWidgetClass)
    {
        ...
        menu->setTitle(QApplication::translate("MainWidgetClass", "\350\217\234\345\215\225", Q_NULLPTR));
        toolBar->setWindowTitle(QApplication::translate("MainWidgetClass", "toolBar", Q_NULLPTR));
    } // retranslateUi
